const ALL_QUESTIONS = [
  // ── Music ────────────────────────────────────────────────────────────────
  { q: "Which rapper's debut album was 'Reasonable Doubt' (1996)?", a: 0, choices: ["JAY-Z","Nas","Biggie","Rakim"], cat: "🎵 Music", pts: 100 },
  ...
  { q: "Which city's music scene coined the term 'Dirty South'?", a: 2, choices: ["Houston","Memphis","Atlanta","New Orleans"], cat: "🎵 Music", pts: 200 },
  { q: "Which artist is known for '4:44' and 'The Blueprint'?", a: 0, choices: ["JAY-Z","Kanye West","Nas","Lil Wayne"], cat: "🎵 Music", pts: 100 },
  ...
  { q: "What label did Jay-Z found in 1996?", a: 2, choices: ["Bad Boy","Death Row","Roc-A-Fella","Def Jam"], cat: "🎵 Music", pts: 200 },
  ...
  { q: "Which Spike Lee film is set in Brooklyn on the hottest day of summer?", a: 0, choices: ["Do the Right Thing","Malcolm X","Crooklyn","She's Gotta Have It"], cat: "📺 TV & Film", pts: 100 },
  { q: "Which show featured the Huxtable family?", a: 1, choices: ["Family Matters","The Cosby Show","Fresh Prince","Martin"], cat: "📺 TV & Film", pts: 100 },
  { q: "Who played T'Challa / Black Panther in the 2018 film?", a: 0, choices: ["Chadwick Boseman","Michael B. Jordan","Idris Elba","Chiwetel Ejiofor"], cat: "📺 TV & Film", pts: 100 },
  ...
  { q: "Who was the first Black quarterback to win a Super Bowl MVP?", a: 0, choices: ["Doug Williams","Donovan McNabb","Colin Kaepernick","Cam Newton"], cat: "🏆 Sports", pts: 200 },
  { q: "Which golfer became the youngest Masters champion in 1997?", a: 1, choices: ["Lee Elder","Tiger Woods","Vijay Singh","Phil Mickelson"], cat: "🏆 Sports", pts: 100 },
  ...
  { q: "The 'Harlem Renaissance' was primarily a movement of?", a: 1, choices: ["Sports","Art, literature & music","Politics","Fashion"], cat: "✊ Culture", pts: 200 },
  ...
  { q: "Which city is home to the historic neighborhood known as 'Black Wall Street'?", a: 1, choices: ["Atlanta","Tulsa","Durham","Memphis"], cat: "✊ Culture", pts: 200 },

  // ── Fashion ──────────────────────────────────────────────────────────────
  { q: "Which designer created the 'Yeezy' fashion line?", a: 1, choices: ["Jay-Z","Kanye West","Pharrell Williams","Diddy"], cat: "👗 Fashion", pts: 100 },
  { q: "Virgil Abloh was creative director of which brand's menswear?", a: 2, choices: ["Gucci","Prada","Louis Vuitton","Balenciaga"], cat: "👗 Fashion", pts: 200 },
  ...
  { q: "Dapper Dan is a legendary fashion designer from which city?", a: 0, choices: ["Harlem","Atlanta","Chicago","Detroit"], cat: "👗 Fashion", pts: 200 },
];
...
module.exports = { ALL_QUESTIONS, shuffle, genCode };
